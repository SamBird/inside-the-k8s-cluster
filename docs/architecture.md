...
- `/graph` `vis-network` visualization with deterministic left-to-right lanes for control-plane concepts plus live discovered resources/nodes/pods/traffic readiness links
